...
function Tagline(){
	...
	return (
		<section className="mt-3">
			...
			<Row>
				<Col lg="3 mt-5  px-4">
					<img src="/src/assets/img/icon/heart-icon.svg" alt="icone coeur" width="80" height="80"/>
					<p className="mt-4">Des rencontres basées sur vos centres d’intérêt</p>
				</Col>
				<Col lg="3  mt-5  px-4">
					<img src="/src/assets/img/icon/event-icon.svg" alt="icone calendrier" width="80" height="80"/>
					<p  className="mt-4">Participez à des événements pour rencontrer en vrai</p>
				</Col>
				<Col lg="3 mt-5  px-4">
					<img src="/src/assets/img/icon/easy-icon.svg" alt="icone doigts" width="80" height="80"/>
