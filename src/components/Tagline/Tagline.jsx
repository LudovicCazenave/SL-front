...
function Tagline(){
	...
	return (
		<section className="mt-3">
			...
			<Row>
				<Col lg="3 mt-5  px-4">
					<img src="/assets/img/icon/heart-icon.svg" alt="icone coeur" width="80" height="80"/>
				...
				<Col lg="3  my-5  px-4">
					<img src="/assets/img/icon/verified-profil.svg" alt="icone profil vérifié" width="80" height="80"/>
